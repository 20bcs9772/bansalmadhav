        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skills.map((skill, index) => {
            ...
            const colorClasses = {
              ...
              green:
                "from-green-500/20 to-green-600/20 border-green-500/30 hover:border-green-400",
              ...
              orange:
                "from-orange-500/20 to-orange-600/20 border-orange-500/30 hover:border-orange-400",
            };
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <Icon
                    className={`w-8 h-8 ${iconColors[skill.color]} group-hover:scale-110 transition-transform`}
                  />
