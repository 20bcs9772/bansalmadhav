...
const PersonalProjects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "An event management platform with a mobile app frontend and a Node.js backend to coordinate large events.",
    ...
    },
    {
      ...
      description:
        "An immersive, interactive 3D model viewer built with Next.js",
    ...
    },
    {
      ...
      description:
        "A modern, interactive node-based visual programming interface for building pipelines with dynamic features and backend validation.",
      tech: ["React Flow", "DAG validation", "Zustand", "FastAPI"],
    ...
    },
    {
      title: "Yelpcamp",
      description:
        "A full-stack Node.js web application for discovering, creating, and reviewing campgrounds with user authentication and CRUD functionality",
      tech: ["Node.js", "Maps", "MongoDB", "Joi", "Cloudinary"],
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 auto-rows-[200px]">
          {projects.map((project, index) => {
            const sizeClasses = {
              ...
              medium: "col-span-2 md:col-span-2 lg:col-span-1 row-span-2",
              small: "col-span-2 md:col-span-1 row-span-1",
            };
            ...
            return (
              <motion.div
                ...
                className={`group ${project.size === "small" ? "hidden md:block" : "block"} relative bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700 hover:border-purple-500/50 transition-all overflow-hidden ${sizeClasses[project.size]}`}
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {project.tech
                      .slice(0, project.size === "small" ? 2 : 5)
                      .map((tech, i) => (
                        <span
                          key={i}
